...
constexpr auto MAX_TWIST = NUM_SPELL_GEMS + CLICK_MAX - 1;   // how many total songs can be twisted .. /twist 1 2 3 1 2 4 ...
...
PLUGIN_API VOID InitializePlugin(VOID)
{
    ...
    WriteChatf("\atMQ2Twist \agv%1.2f loaded.", MQ2Version);
}
